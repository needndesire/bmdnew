            ...
            <section className='bg-white text-black '>
                ...
                <div className='h-[275px]  md:h-[300px] lg:h-[350px] shadow-md rounded-[4px]'>
                        ...
                        <Link href='/Hospitaldetail'>
                         <button type='submit' className='border block m-auto text-[16px] lg:text-[18px]  bg-[#2c4cdb] text-white rounded-md lg:h-[40px] h-[25px] sm:h-[30px] mt-2 w-[70%] sm:w-[65%]' onClick={()=>setheader('hidden')}>SEE MORE </button></Link>
                      
                     
                    </div>
                    <div className='h-[275px]  md:h-[300px] lg:h-[350px] shadow-md rounded-[4px]'>
                        <img src='https://static.vecteezy.com/system/resources/thumbnails/000/219/529/small/medical-background.jpg' className='h-[55%] w-full rounded-[4px]' />
                        <h2 className='text-[20px] font-[700] px-1'>Healers Hospital 
                        </h2>
                        <p className='px-1 text-[10px] lg:text-[15px] md:text-[13px]'>
                        is a leading multispecialty hospital located in Bijnor. Renowned for its exceptional patient-centered care
                    ...
                    <div className='h-[275px]      md:h-[300px]  lg:h-[350px]  rounded-[4px] shadow-md'>
                        3
                    </div>
                    <div className='h-[275px]      md:h-[300px]  lg:h-[350px]  rounded-[4px] shadow-md'>
                        3
